...
The following gas measurements were captured from our test suite using `REPORT_GAS=true npx hardhat test` on the local fhEVM mock environment (360 tests, all passing).
