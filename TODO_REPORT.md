...
- **11 exercise templates** + **11 solutions** - For hands-on learning
...
| 22 | ConfidentialDAO.sol | 14 | Compiles + Tests |
...
5. **On-chain deployment** - 21 contracts deployed to Ethereum Sepolia (see README.md for addresses).
